 ...
 */
$reCAPTCHAsiteKey = "6LeDiH8UAAAAAF1lrTDeqopXlnnD5objAeTmzT8p";
...
class Database
{
    ...
    public static function reCAPTCHAvalidate($captcha)  {
        ...
        $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret="6LeDiH8UAAAAADrVVbLFAMMuGpRLp1wpGc07FvHe"&response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
